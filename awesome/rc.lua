...
-- awful.layout.layouts = beautiful.layouts
...
-- theme.wallpaper_cmd = {os.getenv("HOME") .. "/.fehbg"}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey            }, "d", function () awful.spawn("rofi -show drun") end,
              {description = "rofi launcher", group = "awesome"}),
...
client.connect_signal("manage", function (c)
    ...
    if not c.maximized then
      ...
      c.shape = gears.partially_rounded_rect
    end
end)
